...
/**
 * CLASSE PreferencesTranscodeurManager :<br/>
 ...
 *
 */
public final class PreferencesTranscodeurManager {
	...
	private static final Log LOG 
		= LogFactory.getLog(PreferencesTranscodeurManager.class);
	

	// *************************METHODES************************************/

	 /**
	 * method CONSTRUCTEUR PreferencesTranscodeurManager() :<br/>
	 * CONSTRUCTEUR D'ARITE NULLE.<br/>
	 * - private pour bloquer l'instanciation.<br/>
	 */
	private PreferencesTranscodeurManager() {		
		super();
	...
	private static void initialiserPreferences() throws Exception {
		...
		synchronized (PreferencesTranscodeurManager.class) {
...
} // FIN DE LA CLASSE PreferencesTranscodeurManager.------------------------------------
