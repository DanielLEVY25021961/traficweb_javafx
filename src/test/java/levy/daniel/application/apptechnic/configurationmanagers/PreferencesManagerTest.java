 ...
 * Test JUnit de la classe PreferencesTranscodeurManager.<br/>
 * <br/>
 *
...
public class PreferencesManagerTest {
	...
	public void testCreerOuModifier() throws Exception {
		...
		if (AFFICHAGE_GENERAL && affichage) {
			...
			System.out.println(INITIAL + PreferencesTranscodeurManager.afficherPreferences());
		}
		
		final Properties preferences 
			= PreferencesTranscodeurManager.getPreferences();
		
		final int tailleInitiale = preferences.size();
		
		PreferencesTranscodeurManager.creerOuModifierProperty(KEY_TEST, VALUE_TEST);
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println(FINAL + PreferencesTranscodeurManager.afficherPreferences());
		}

		PreferencesTranscodeurManager.creerOuModifierProperty(KEY_TEST, "test_modifié");
		...
		if (AFFICHAGE_GENERAL && affichage) {
			...
			System.out.println();
			System.out.println("PROPERTIES FINAL APRES MODIFICATION : \n" + PreferencesTranscodeurManager.afficherPreferences());
		}
		
		PreferencesTranscodeurManager.retirerProperty(KEY_TEST);
	...
	public void testRetirer() throws Exception {
		...
		PreferencesTranscodeurManager.creerOuModifierProperty("key.test.retirer", VALUE_TEST);
		...
		PreferencesTranscodeurManager.retirerProperty("key.test.retirer");
	...
	public void testGetCharsetSupposeEntreeParDefaut() throws Exception {
		...
		final Charset charset 
			= PreferencesTranscodeurManager.getCharsetSupposeEntreeParDefaut();
	...
	public void testGetRepEntreeParDefaut() throws Exception {
		...
		final File repertoire 
			= PreferencesTranscodeurManager.getRepFichiersEntreeParDefaut();
	...
	public void testGetCharsetSortieParDefaut() throws Exception {
		...
		final Charset charset 
			= PreferencesTranscodeurManager.getCharsetSortieParDefaut();
